            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr style={{borderBottom: '1px solid #1a1a1a'}}>
                  ...
                  <td className="px-6 py-4 text-center text-red-400 font-bold">15–20%</td>
                ...
                <tr style={{borderBottom: '1px solid #1a1a1a'}}>
                  ...
                  <td className="px-6 py-4 text-center text-red-400 font-bold">10–15%</td>
                  <td className="px-6 py-4 text-center text-gray-400">~85%</td>
                </tr>
                <tr style={{borderBottom: '1px solid #1a1a1a'}}>
                  <td className="px-6 py-4 text-gray-300 font-medium">Etsy</td>
                  <td className="px-6 py-4 text-center text-gray-400">£0</td>
                  <td className="px-6 py-4 text-center text-red-400 font-bold">6.5% + fees</td>
                  <td className="px-6 py-4 text-center text-gray-400">~90%</td>
                </tr>
                <tr style={{background: '#1a1400'}}>
                  <td className="px-6 py-5 font-black text-lg" style={{color: '#fcd968'}}>🇬🇧 BigDiscounts</td>
                  <td className="px-6 py-5 text-center font-black text-lg" style={{color: '#fcd968'}}>£1/month</td>
                  <td className="px-6 py-5 text-center font-black text-lg text-green-400">0%</td>
                  <td className="px-6 py-5 text-center font-black text-lg text-green-400">100%</td>
                </tr>
              </tbody>
            </table>
          </div>
